    ...
    <div>
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Pembelian Barang</h1>
                {{-- Asumsi Anda memiliki route untuk kembali ke daftar produk --}}
                <a href="{{ route('admin.barang.index') }}"
                    class="text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                    &larr; Kembali ke Daftar Pembelian Barang
                </a>
            </div>
            ...
            <form wire:submit.prevent="saveProduct" class="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                {{-- Input Harga Beli --}}
                <div>
                    <label for="harga_beli" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga
                        Beli</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    {{-- Jenis Stock --}}
                    <div>
                        <label for="jenis_stock"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Stock</label>
                ...
                <div class="flex justify-end pt-4">
                    <button type="submit" wire:loading.attr="disabled" wire:target="saveProduct"
                        ...
                        <span wire:loading.remove wire:target="saveProduct">Tambah Pembelian</span>
