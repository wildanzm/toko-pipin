    ...
    <div>
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            ...
            <form wire:submit.prevent="saveProduct" class="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                {{-- Status Pembelian --}}
                <div>
                    <label for="harga_jual" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status Pembelian</label>
                    <select id="statusPembelian" wire:model.live="statusPembelian"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
