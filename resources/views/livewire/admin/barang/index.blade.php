<div>
    ...
    {{-- Area Tombol Filter dan Pencarian --}}
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
        ...
        <div class="w-full md:w-1/3">
            ...
            <input wire:model.live.debounce.300ms="search" type="search" id="search"
                ...
                placeholder="Cari berdasarkan nama, kode, atau toko...">
        </div>
    </div>

    {{-- Area Tombol Aksi (Tambah dan Export) --}}
    <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3">
        <div class="flex items-center gap-2">
            ...
            <button wire:click="exportPdf" wire:loading.attr="disabled"
                class="px-4 py-2 text-sm text-white bg-red-600 rounded-lg hover:bg-red-700 transition disabled:opacity-50">
                <span wire:loading wire:target="exportPdf" class="animate-spin">&#9696;</span>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-center">
                            @if ($barang->status_pembelian === 'Diterima')
                                <span
                                    class="inline-block px-3 py-1 text-sm font-semibold text-white bg-cyan-500 rounded-full">
                                    Diterima
                                </span>
                            @else
                                <span
                                    class="inline-block px-3 py-1 text-sm font-semibold text-white bg-orange-500 rounded-full">
                                    Dikembalikan
                                </span>
                            @endif
    </div>
                ...
                <div x-data="{ jenisPembayaran: @entangle('editingBarang.jenis_pembayaran') }">
                    <div class="mb-4">
                        <label for="jenis_pembayaran"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Jenis Pembayaran</label>
                    ...
                    <div class="mb-4" x-show="jenisPembayaran === 'kredit'" x-transition>
                        <label for="pembayaran"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Nominal Pembayaran</label>
                    ...
                    <div class="mb-4">
                        <label for="status_pembelian"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Status Pembelian</label>
